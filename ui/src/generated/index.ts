...
export type Settings = {
  ...
  cliWipeBehavior: Scalars['String'];
  cliMessagePersistLimit: Scalars['Float'];
  keysRefreshInterval: Scalars['Float'];
};
...
export type SettingsQuery = { settings: Pick<Settings, 'willPromptBeforeDelete' | 'willSaveCliOutput' | 'cliWipeBehavior' | 'cliMessagePersistLimit' | 'keysRefreshInterval'> };
